...
export const DESTINATION_IMAGES = {
  PARIS_1889: {
    id: 'paris-1889',
    name: 'Paris 1889',
    heroUrl: process.env.REACT_APP_PARIS_1889_HERO || 'https://placeholder.com/paris.jpg',
    alt: 'Paris 1889 - Belle Époque',
    optimized: true, // Using Cloudinary/Supabase with optimization
  },
  CRETACEOUS: {
    id: 'cretaceous',
    name: 'Crétacé',
    heroUrl: process.env.REACT_APP_CRETACEOUS_HERO || 'https://placeholder.com/cretaceous.jpg',
  ...
  FLORENCE_1504: {
    id: 'florence-1504',
    name: 'Florence 1504',
    heroUrl: process.env.REACT_APP_FLORENCE_1504_HERO || 'https://placeholder.com/florence.jpg',
...
export const LOGO_URL = process.env.REACT_APP_LOGO_URL || 'https://placeholder.com/logo.png'
export const FAVICON_URL = process.env.REACT_APP_FAVICON_URL || 'https://placeholder.com/favicon.ico'
...
export const getImageUrl = (destinationId) => {
  ...
  return destination?.heroUrl || 'https://placeholder.com/image.jpg'
}
